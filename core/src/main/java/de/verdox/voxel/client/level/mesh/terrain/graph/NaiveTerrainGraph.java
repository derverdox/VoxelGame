...
public class NaiveTerrainGraph implements TerrainGraph {
    ...
    public NaiveTerrainGraph(TerrainManager terrainManager, int chunkSizeX, int chunkSizeY, int chunkSizeZ) {
