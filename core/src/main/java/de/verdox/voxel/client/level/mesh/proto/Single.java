...
public class Single extends ProtoMask {
    ...
    @Override
    public int getBitSizePerFace(ChunkProtoMesh chunkProtoMesh) {
        return chunkProtoMesh.getLocalXByteSize()
                + chunkProtoMesh.getLocalYByteSize()
                + chunkProtoMesh.getLocalZByteSize()
