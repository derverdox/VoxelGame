...
public class PlainDynamicShortBuffer implements DynamicShortBuffer {
     ...
     */
    public PlainDynamicShortBuffer(int initialCapacity, boolean alwaysExact) {
    ...
    public void set(int index, short value) {
        ...
        if (index >= size) {
            ...
            Arrays.fill(buffer, size, index, (short) 0);
            size = index + 1;
        }
        buffer[index] = value;
    }
    ...
    @Override
    public void fill(int start, int length, short value) {
        if (start < 0 || length < 0) {
    ...
    @Override
    public void set(int pos, short[] src) {
    ...
    @Override
    public int update(int startIndex, int endIndex, short[] newData) {
    ...
    @Override
    public void insert(int pos, short[] src) {
        if (pos < 0 || pos > size) {
