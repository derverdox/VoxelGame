...
public interface DynamicIntBuffer {
    /**
    ...
    void fill(int start, int length, int value);
    ...
    int update(int startIndex, int endIndex, int[] newData);

    /**
     * Fügt ab index 'pos' das komplette Array 'src' ein
     */
    void insert(int pos, int[] src);
