...
public class PlainDynamicIntBuffer implements DynamicIntBuffer {
     ...
     */
    public PlainDynamicIntBuffer(int initialCapacity, boolean alwaysExact) {
    ...
    public void set(int index, int value) {
        ...
        if (index >= size) {
            ...
            Arrays.fill(buffer, size, index, 0);
            size = index + 1;
        }
        buffer[index] = value;
    }
    ...
    @Override
    public void set(int pos, int[] src) {
    ...
    @Override
    public int update(int startIndex, int endIndex, int[] newData) {
    ...
    @Override
    public void insert(int pos, int[] src) {
        if (pos < 0 || pos > size) {
